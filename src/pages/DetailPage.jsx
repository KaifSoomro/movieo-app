    ...
    <div className='px-3'>
      ...
      <div className='container mx-auto py-16 lg:py-0 flex gap-5 lg:gap-10 flex-col lg:flex-row'>
        ...
        <div>
          ...
          <div>
              <p><span className='text-white font-semibold'>Director</span> : { castData?.crew[0]?.name }</p>
              <Divider />
              <p><span className='text-white font-semibold'>Writer</span> : { writer }</p>
          </div>

          <Divider />
          <h2 className='font-semibold text-white text-lg'>Cast : </h2>
          <div className='grid grid-cols-[repeat(auto-fit,96px)] gap-5 mt-4'>
              {
