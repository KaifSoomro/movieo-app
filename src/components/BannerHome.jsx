                ...
                bannerData.map((data,index)=>{
                    return (
                        <div  key={data.id+"bannerHome"+index} className='min-w-full min-h-[450px] lg:min-h-full overflow-hidden relative group transition-all' style={{transform : `translateX(-${currentImage * 100}%)`}}>
                            ...
                            <div className='absolute top-0 w-full h-full hidden items-center justify-between z-10 px-8 lg:group-hover:flex'>
                            ...
                            <div className='container mx-auto'>
                                <div className='w-full absolute bottom-0 max-w-md px-3'>
                                    ...
                                    <Link to={'/'+data.media_type+'/'+data.id} >
                                        <button className='bg-white px-4 py-2 text-black font-bold rounded-sm mt-4 hover:bg-linear-to-l from-red-500 to-orange-500 shadow-md transition-all hover:scale-105'>
                                            Play Now
                                        </button>
                                    </Link>
                                </div>
